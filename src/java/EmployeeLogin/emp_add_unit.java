 ...
 */
@WebServlet(name = "emp_add_unit", urlPatterns = {"/emp_add_unit"})
public class emp_add_unit extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("emp_add_unit.jsp").forward(request, response);
        processRequest(request, response);
    }
