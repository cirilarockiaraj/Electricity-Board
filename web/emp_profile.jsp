                                ...
                                <div class="col-md-12 grid-margin stretch-card">
                                    <div class="card">
                                        <section class="p-5">
                                            <div class="row">
                                                <div class="col-12">
                                                    <img src="emp_profiles/${emp.image}" style="border: 1px solid black; border-radius: 5px;" width="150" height="190" class="float-end" alt="image error">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row p-1">
                                            ...
                                            <div class="col-4">
                                                <h6>${emp.profession}</h6>
                                            </div>
                                        </div>
                                        <div class="row p-1">
                                            <div class="col-4">
                                                <h6>Currently working district</h6>
                                            </div>
                                            <div class="col-4">
                                                <h6>${emp.district}</h6>
                                            </div>
