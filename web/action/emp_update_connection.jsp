...
<html>
    <head>
        ...
        <title>Employee | update connection</title>
    ...
    <body class="container-md p-5">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="float-end">
                    <p class="mb-0"><a class="small text-muted font-weight-bold text-decoration-none" href="../emp_view_connection.jsp">< Back to dashboard</a>
                    </p>
                </div>
                <form method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="" value="<%= res.getString("service_holder_name")%>" required="">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputPassword1">Father's name</label>
                        <input type="text" class="form-control" name="father_name" value="<%= res.getString("father_name")%>" required="">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Occupation</label>
                        <input type="text" class="form-control" name="occupation" value="<%= res.getString("occupation")%>" id="exampleInputEmail1" required="">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Gender</label>
                        <select class="form-select" name="gend" aria-label="Default select example" required="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="dob" value="<%= res.getString("date_of_birth")%>" required="">
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">House/flat no</label>
                        <input type="text" class="form-control" name="flat_no" value="<%= res.getString("house_no")%>" required="">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Village/city name</label>
                        <input type="text" class="form-control" name="city" value="<%= res.getString("city_village_town_name")%>" required="">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pincode" value="<%=res.getString("pincode")%>" required="">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Contact number</label>
                        <input type="text" class="form-control" name="contact" value="<%= res.getString("mobile_no")%>" required="">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Additional contact number</label>
                        <input type="text" class="form-control" name="add_cont" value="<%= res.getString("additional_mobile_no")%>" required="">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Email id</label>
                        <input type="email" class="form-control" name="email" value="<%= res.getString("email_id")%>" required="">
                    </div>

                    <button type="submit" name="submit" class="btn btn-gradient-primary me-2">Update</button>
                    <button class="btn btn-gradient-danger"><a href="../emp_view_connection.jsp" class="text-light text-decoration-none" >Cancel</a></button>
