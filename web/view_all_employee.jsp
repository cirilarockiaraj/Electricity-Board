                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="list" class="table table-hover" cellspacing="0" width="100%">
                                            ...
                                            <tr>
                                                <td class="py-1">
                                                    <img src="emp_profiles/<%= rs.getString("image")%>" alt="image" />
                                                </td>
                                                ...
                                                <td> <%= rs.getString("hire_district")%> </td>
                                                <td> <%= rs.getString("office")%> </td>
                                                <td> <%= rs.getString("address")%> </td>
                                                <td> <%= rs.getString("data_added_date_time")%> </td>

                                                <td>
                                                    <a href="action/update_employee.jsp?id=<%=id%>"><i class="fas fa-edit text-md-start" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        function confirm(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    location.href = "delete_employee?id=" + id;
                }
            })
        }
    </script>
