                                    ...
                                    <table id="list" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                        ...
                                        <%
                                            try {
                                                ...
                                                String sql = "SELECT * FROM admin_profile";
                                        ...
                                        <tr>
                                            <td class="py-1">
                                                <img src="admin_profiles/<%= rs.getString("image")%>" alt="image" />
                                            </td>
                                            ...
                                            <td>
                                                <a href="action/update_admin.jsp?id=<%=id%>"><i class="fas fa-edit text-md-start" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    function confirm(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                location.href = "delete_admin?id=" + id;
            }
        })
    }
</script>
