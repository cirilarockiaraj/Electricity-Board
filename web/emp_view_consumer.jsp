...
<html lang="en">
    <head>
        ...
        <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script><link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.11.3/css/dataTables.bootstrap5.min.css"/>
                            ...
                            <div class="col-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="scroll">
                                            <table class="table table-striped table-bordered table-hover" cellspacing="0" id="list" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="action/emp_update_consumer.jsp?id=<%=id%>"><i class="fas fa-edit text-md-start" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        function confirm(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    location.href = "emp_delete_consumer?id=" + id;
                }
            })
        }
    </script>
